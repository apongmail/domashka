# Домашка №1 — DevOps Frameworks & SDLC

**Автор:** Андрій Пономарьов / Claude Code Opus 4.8

Дослідницьке завдання з трьох частин:

1. **CALMS** — ознайомлення з фреймворком (Atlassian).
2. **Інші фреймворки** — список з коротким описом.
3. **SDLC** — резюме опису життєвого циклу розробки ПЗ з посиланнями.
