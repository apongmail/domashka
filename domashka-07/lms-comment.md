...
Застосунок — лічильник візитів на Flask + PostgreSQL (~30 рядків Python):
кожен GET додає рядок у таблицю і повертає кількість візитів.
...
- **1-ша збірка:** 7.66 с (з них `pip install` — 5.3 с)
- **2-га збірка** (змінено один символ у `app.py`): **1.09 с** — шари до
