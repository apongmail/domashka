...
Посеред курсу я замінив домашній роутер і прогнав усю роботу повторно —
вийшов природний експеримент: DNS-записи, шлях від IX до Hetzner і всі
таймінги збіглись, але в traceroute додався 13-й хоп (перед мережею
провайдера тепер стоїть мій власний NAT-сегмент 192.168.8.0/24), а в
handshake з'явився MSS clamping до 1400 від нового роутера.
